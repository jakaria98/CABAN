...
const Sked = () => {
    return (
        <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div className="row row-cols-md-4 d-flex align-items-center justify-content-between mt-5 text-center">
                <PAXWeight />

                <CardHead height="33rem" bgColor="#f4f4f4" border="none">
                    <CardHead height="10rem" bgColor="#f4f4f4">
                        <div className="card-body d-flex align-items-center justify-content-center">
                            <p className="card-text">Cargo Allocated to flight Pieces and Weight</p>
                        </div>
                    </CardHead>
                    <CardHead height="10rem">
                        <div className="card-body d-flex align-items-center justify-content-center">
